...
export const TRANSLATIONS = {
    en: {
        ...
        blue_orb_fail_riding: "§cBlue Orb can only catch mobs you are riding!"
    },
    es: {
        ...
        trust_remove_confirm_body: "¿Estás seguro de querer eliminar a %s de tu lista de confianza?",
        ...
        invitations_btn: "§aTienes §c§l[%s]§r§a Notificaciones Sociales, revisa tu §dMount Orb",
        btn_release: "Liberar Mob",
        btn_move_top: "Mover al Inicio",
        // New Additions
        tame_fail_melon_count: "§cNecesitas 20 Rodajas de Sandía Reluciente para domesticar este mob.",
        tame_success_generic: "§a¡Has domesticado esta montura!",
        harness_fail_equipped: "§c¡Ya tiene un arnés!",
        harness_equip_success: "Arnés Equipado",
        blue_orb_fail_riding: "§c¡El Orbe Azul solo puede capturar mobs que estés montando!"
    }
};
